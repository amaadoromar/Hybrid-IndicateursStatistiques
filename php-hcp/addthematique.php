...
<center>
    <form class="myPost" method="post" action="./config/actions.php">
        ...
        <input style="width: 20%;" class="form-control" list="browsers" id="idcategory" cols="1" rows="1" name="idcategory"  >
      ...
      ?>
            ...
            <br><input value="Ajouter la thematique" type="submit" name="addthematique" class="btn btn-primary">
        </form>
        <?php 
